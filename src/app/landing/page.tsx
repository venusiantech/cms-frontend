                        ...
                        <div className="container mx-auto px-6">
                            ...
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                                ...
                                <div className="group relative overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.1)] bg-[rgb(17,17,19)] p-8 transition-all duration-300 hover:-translate-y-2 hover:border-[rgb(218,255,1)]">
                                    <div className="absolute top-0 right-0 left-0 h-0.5 bg-[rgb(218,255,1)] opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
                                    <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-[rgba(218,255,1,0.1)]">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shopping-bag text-[rgb(218,255,1)]" aria-hidden="true">
                            ...
                            <div className="mx-auto max-w-3xl space-y-4">
                                <div className="overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.1)] bg-[rgb(26,28,30)] transition-all duration-300 hover:border-[rgb(218,255,1)]">
                                    <button className="flex w-full items-center justify-between p-6 text-left">
                                        <span className="pr-4 text-lg font-semibold">What exactly do I get for free?</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down flex-shrink-0 text-[rgb(218,255,1)] transition-transform duration-300" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg>
                                    </button>

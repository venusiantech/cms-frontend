...
import CategoryBadgeList from '../PostCards/CategoryBadgeList'
            ...
            >
              <div className="relative">
                ...
                <button
                  ...
                  type="button"
                >
                  <X className="block h-5 w-5 sm:hidden" />
    ...
    <div className={`group relative flex flex-row-reverse gap-3 rounded-2xl p-4 sm:gap-5`}>
      <div className="space-y-3">
        ...
        <h4 className="mt-2 text-sm leading-6 font-medium text-neutral-900 dark:text-neutral-300">
          <Link className="absolute inset-0" href={`/blog/${post.handle}`} />
          {post.title}
        </h4>
      </div>
